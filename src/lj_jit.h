...
#define JIT_F_ISA30		(JIT_F_CPU << 2)	/* PPC64: ISA 3.0 (POWER9). */

#define JIT_F_CPUSTRING		"\4SQRT\5ROUND\6ISA3.0"
...
enum {
  ...
  LJ_K64_2P31,		/* 2^31 */
#endif
#if LJ_TARGET_ARM64 || LJ_TARGET_MIPS64 || LJ_ARCH_PPC64
  LJ_K64_VM_EXIT_HANDLER,
  LJ_K64_VM_EXIT_INTERP,
#endif
  LJ_K64__MAX,
};
#define LJ_K64__USED	(LJ_TARGET_X86ORX64 || LJ_TARGET_ARM64 || LJ_TARGET_MIPS || LJ_ARCH_PPC64)
...
enum {
  ...
  LJ_K32_2P31,		/* 2^31 */
#endif
#if (LJ_TARGET_PPC && !LJ_ARCH_PPC64) || LJ_TARGET_MIPS32
